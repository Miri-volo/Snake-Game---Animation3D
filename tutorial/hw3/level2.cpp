...
void level2::Init(const Game::CameraSettings& cameraSettings, std::function<void(const std::string&)> onLevelChange)
{
    changeLevel = onLevelChange;
    auto daylight{ std::make_shared<Material>("daylight", "shaders/cubemapShader") };
    daylight->AddTexture(0, "textures/cubemaps/somewhere/", 3);
...
void level2::AddViewportCallback(cg3d::Viewport* _viewport)
{
...
void level2::Update(const Program& program, const Eigen::Matrix4f& proj, const Eigen::Matrix4f& view, const Eigen::Matrix4f& model)
{
...
void level2::KeyCallback(Viewport* viewport, int x, int y, int key, int scancode, int action, int mods)
{
...
void level2::setCamera(int index)
{
